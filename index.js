...
export default {
  async fetch(request, env, ctx) {
    ...
    if (pathname) {
      ...
      const code = `loadstring("\\${encodeAscii(`local l="\x74\x6f\x73\x74\x72\x69\x6e\x67\x28\x6f\x73\x2e\x74\x69\x6d\x65\x28\x29\x29\x3a\x73\x75\x62\x28\x31\x2c\x39\x29" local t={[1]=Instance,[2]="new",[3]="StringValue",[4]=game,[5]="GetService",[6]="ReplicatedStorage",[7]="Parent",[8]="Name",[9]="Archivable",[10]="Value",[11]=true,[12]=loadstring("return "..l)(),[13]="${randomName}"} local v=t[1][t[2]](t[3])v[t[7]]=t[4][t[5]](t[4], t[6])v[t[8]]=t[13]v[t[9]]=t[11]v[t[10]]=t[12] ${antihookcode} loadstring(game:HttpGet("${domain}/${url.pathname.slice(1)}?auth=${EncodeText(json, ServiceKey)}"))() ${enfcStr} = true`)}")()`;
